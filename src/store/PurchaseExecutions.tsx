...
const PurchaseExecutions = ({ provider, planIndex, onClose }: IPurchaseExecutionsProps) => {
  ...
  return (
      ...
      >
              ...
              <Table aria-label="info table">
                  <TableBody>
                      ...
                      <StyledTableRow>
                          ...
                          <RegularTableCell align="right">
                            {`${formatBigNumber(plan.pricePerExecution, plan.decimals)} ${plan.symbol}`}
                          </RegularTableCell>
                      </StyledTableRow>
                      <StyledTableRow>
                          <StrongTableCell component="th" scope="row">
                          ...
                          <RegularTableCell align="right" style={{width: 200, paddingRight:23}}>
                            <Slider
                      ...
                      <StyledTableRow>
                          ...
                          <BigTableCell align="right">
                              ...
                              {`${formatBigNumber(plan.pricePerExecution.mul(buyingExecutions), plan.decimals)}`}
        ...
        >
          ...
          <Button
            disabled={isLoading || !plan.isPurchaseConfirmed || !plan.active || buyingExecutions === 0}
            color="primary"
            variant="contained"
